...
df= pd.read_csv('/Users/jyotismac/Desktop/sales_data.csv')
...
# code sourced from below reference
#(https://365datascience.com/tutorials/python-tutorials/predictive-model-python/#5)
...
# code source- https://www.digitalocean.com/community/tutorials/pandas-dropna-drop-null-na-values-from-dataframe
...
# replacing null values in house_owner column 
# with owner if value in house_val is more than 0, else,renter
...
# code adopted and modified from- https://stackoverflow.com/questions/19966018/pandas-filling-missing-values-by-mean-in-each-group
...
# code source- https://towardsdatascience.com/how-to-bin-numerical-data-with-pandas-fe5146c9dc55
...
# code source- https://sparkbyexamples.com/pandas/pandas-replace-by-examples/
...
# code source- https://towardsdatascience.com/a-complete-guide-to-plotting-categorical-variables-with-seaborn-bfe54db66bec#52ab
...
# code adopted from https://pythonbasics.org/seaborn-barplot/
...
# code source- https://plotly.com/python/histograms/ 
...
# code source- https://www.statology.org/k-fold-cross-validation-in-python/
...
# #### Code source - [https://www.analyticsvidhya.com/blog/2020/06/auc-roc-curve-machine-learning/] 
